...
// MeetingRoomDlg.cpp : 实现文件
//

#include "stdafx.h"
#include "MeetingRoom.h"
#include "MeetingRoomDlg.h"
...
CMeetingRoomDlg::CMeetingRoomDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMeetingRoomDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMeetingRoomDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMeetingRoomDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CMeetingRoomDlg 消息处理程序

BOOL CMeetingRoomDlg::OnInitDialog()
{
...
void CMeetingRoomDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMeetingRoomDlg::OnQueryDragIcon()
{
...
void CMeetingRoomDlg::OnSearchmeetingplan()
{
	// TODO:  在此添加命令处理程序代码
